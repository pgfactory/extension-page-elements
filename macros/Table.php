...
$macroConfig =  [
    ...
    'parameters' => [
        ...
        'wrapperClass' => ['(optional) Class applied to the DIV around the table tag (resp. wrapping div tag if renderAsDiv is set). (Default: "pfy-table-default" which applies default styling).',   'pfy-table-default'],
        'tableClass' => ['(optional) Class applied to the table tag (resp. wrapping div tag if renderAsDiv is set). Use "pfy-table-default" to apply default styling.', false],
        'class' => ['Synonyme for tableClass', 'pfy-table'],
        ...
        'rowClass' => ['(optional) Class applied to each table row',  'pfy-row-*'],
        ...
        'multiline' => ['If true (and inline-editing is true), table cells get class "pfy-editable-multiline" thus supporting multiline editing.', false],
