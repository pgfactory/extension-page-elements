...
var FullCalendar = (function (exports) {
  ...
  var n, l$1, u$1, i$1, t, r$1, o, f$1, e$1, c$1 = {}, s = [],
  ...
  class TableDowCell extends BaseComponent {
    render() {
      ...
      return (y(ContentContainer, {
        ...
        elAttrs: Object.assign({role: 'columnheader', colSpan: props.colSpan}, props.extraDataAttrs),
        renderProps: renderProps,
        generatorName: "dayHeaderContent",
        customGenerator: options.dayHeaderContent,
        defaultGenerator: renderInner$1,
  ...
  class DayHeader extends BaseComponent {
    ...
    render() {
      ...
      return (y(NowTimer, {unit: "day"}, (nowDate, todayRange) => (y("tr", {role: "row"},
        ...
        dates.map((date) => (datesRepDistinctDays ? (y(TableDateCell, {
        ...
        })) : (y(TableDowCell, {key: date.getUTCDay(), dow: date.getUTCDay(), dayHeaderFormat: dayHeaderFormat}))))))));
    }
  }
      ...
      for (let widget of widgetGroup) {
        ...
        if (buttonName === 'title') {
          ...
          children.push(y("button", {
            ...
            onClick: buttonClick
          }, buttonText || (buttonIcon ? y("span", {className: buttonIcon, role: "img"}) : '')));
        }
      }
  ...
  class CalendarContent extends PureComponent {
    ...
    render() {
      ...
      return (y(ViewContextType.Provider, {value: viewContext},
        ...
        toolbarConfig.footer && (y(Toolbar, Object.assign({
          ref: this.footerRef,
            ...
            y("tr", {role: "row"},
              props.axis && (y("td", {"aria-hidden": true, className: "fc-timegrid-col fc-timegrid-axis"},
                y("div", {className: "fc-timegrid-col-frame"},
                  y("div", {className: "fc-timegrid-now-indicator-container"}, typeof nowIndicatorTop === 'number' && (y(NowIndicatorContainer, {
                    elClasses: ['fc-timegrid-now-indicator-arrow'],
                    elStyle: {top: nowIndicatorTop},
                    isAxis: true,
                    date: props.nowDate
  ...
  class DayTimeCols extends DateComponent {
    ...
    render() {
      ...
      return (y(NowTimer, {unit: nowIndicator ? 'minute' : 'day'}, (nowDate, todayRange) => (y(TimeCols, Object.assign({ref: this.timeColsRef}, this.slicer.sliceProps(props, dateProfile, null, context, dayRanges), {
        forPrint: props.forPrint,
        axis: props.axis,
        dateProfile: dateProfile,
        slatMetas: props.slatMetas,
  ...
  function renderInnerContent(props) {
    return (y(_, null,
      props.text && (y("a", Object.assign({
        id: props.textId,
        className: "fc-list-day-text"
      }, props.navLinkAttrs), props.text)),
      props.sideText && ( /* not keyboard tabbable */y("a", Object.assign({
        "aria-hidden": true,
  ...
  class ListView extends DateComponent {
    ...
    renderEmptyMessage() {
      ...
      }, (InnerContent) => (y(InnerContent, {elTag: "div", elClasses: ['fc-list-empty-cushion']}))));
    }
